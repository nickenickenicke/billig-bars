  ...
  return (
    <>
      <article className="px-2 pt-6 md:px-8 md:pt-10">
        ...
        <section className="mx-auto grid w-fit grid-cols-[auto,_100px] items-start gap-3 self-start rounded-lg bg-bg-pink px-3 py-4 md:grid-cols-[minmax(auto,_55ch),_auto] md:gap-6 md:px-6 md:py-8 md:text-xl">
